  ...
  config = lib.mkIf config.chonkos.hyprland.enable {
    wayland.windowManager.hyprland = {
      ...
      extraConfig = ''
        ...
        exec-once = "${pkgs.util-linux}/bin/rfkill block bluetooth"
        exec-once = "${pkgs.dunst}/bin/dunst"
        exec-once = ${lib.optionalString config.chonkos.hyprland.enableMpd "${pkgs/mpd}/bin/mpd"}
        exec-once = "setbg"
        exec-once = "${pkgs.swayidle}/bin/swayidle -w before-sleep 'hyprland-before-sleep.sh'"
        exec-once = "pypr"
